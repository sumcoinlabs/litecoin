Litecoin Core version 0.14.2 is now available from:
  ...
  <https://litecoin.org/bin/litecoin-core-0.14.2/>
...
(in Litecoin Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate litecoin-config.h as necessary (theuni)
