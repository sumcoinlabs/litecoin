Litecoin Core version 0.16.3 is now available from:
  ...
  <https://litecoincore.org/bin/litecoin-core-0.16.3/>
...
been discovered in Litecoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` litecoinconsensus: invalid flags error should be set to `litecoinconsensus_err` (afk11)
