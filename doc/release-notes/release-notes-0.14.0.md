Litecoin Core version 0.14.0 is now available from:
  ...
  <https://litecoin.org/bin/litecoin-core-0.14.0/>
...
Litecoin Core has supported automatically pruning the blockchain since 0.11. Pruning
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/litecoin/litecoin/blob/master/doc/zmq.md) for
...
The Alert System was [disabled and deprecated](https://litecoin.org/en/alert/2016-11-01-alert-retirement) in Litecoin Core 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   ...
   optimizations to memory management. See [Pull #8753](https://github.com/litecoin/litecoin/pull/8753)
...
- #8722 `bb843ad` litecoin-cli: More detailed error reporting (laanwj)
...
- #8830 `ef0801b` test: Add option to run litecoin-util-test.py manually (jnewbery)
- #8881 `e66cc1d` Add some verbose logging to litecoin-util-test.py (jnewbery)
...
- #9023 `774db92` Add logging to litecoin-util-test.py (jnewbery)
- #9065 `c9bdf9a` Merge `doc/unit-tests.md` into `src/test/README.md` (laanwj)
- #9069 `ed64bce` Clean up bctest.py and litecoin-util-test.py (jnewbery)
...
- #9691 `fc67cd2` Init ECC context for `test_litecoin_fuzzy` (gmaxwell)
...
- #9865 `289204f` Change litecoin address in RPC help message (marijnfs)
...
- #8813 `fb24d7e` litecoind: Daemonize using daemon(3) (laanwj)
...
- #8837 `2108911` Allow litecoin-tx to parse partial transactions (jnewbery)
- #9204 `74ced54` Clarify CreateTransaction error messages (instagibbs)
- #9265 `31bcc66` litecoin-cli: Make error message less confusing (laanwj)
...
- #8883 `d5d4ad8` Add all standard TXO types to litecoin-tx (jnewbery)
