Litecoin Core version 0.13.2 is now available from:
  ...
  <https://litecoin.org/bin/litecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update litecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow litecoin-tx to create v2 transactions (btcdrak)
