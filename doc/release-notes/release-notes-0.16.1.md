Litecoin Core version 0.16.1 is now available from:
  ...
  <https://litecoincore.org/bin/litecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting litecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure litecoind processes are cleaned up when tests end (sdaftuar)
