Litecoin Core version *0.15.2* is now available from:

  <https://litecoincore.org/bin/litecoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in litecoin-tx (TheBlueMatt)
