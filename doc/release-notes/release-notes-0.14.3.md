Litecoin Core version *0.14.3* is now available from:

  <https://litecoin.org/bin/litecoin-core-0.14.3/>
...
Since 0.14.0 the approximate transaction fee shown in Litecoin-Qt when using coin
...
- #10451 `3612219` contrib/init/litecoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
