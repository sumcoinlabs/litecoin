Litecoin Core version 0.16.0 is now available from:
  ...
  <https://litecoincore.org/bin/litecoin-core-0.16.0/>
...
GUI changes
-----------
- Uses of "µLTC" in the GUI now also show the more colloquial term "bits", specified in BIP176.
...
- #11917 `bc66765` Add testnet DNS seed:  seed.testnet.litecoin.sprovoost.nl (Sjors)
...
- #11970 `b7450cd` Add test coverage for litecoin-cli multiwallet calls (ryanofsky)
...
- #10997 `affe927` Add option -stdinrpcpass to litecoin-cli to allow RPC password to be read from standard input (jharvell)
...
- #12035 `eeb6d52` Change µLTC to bits (jb55)
...
- #11621 `1f7695b` [build] Add temp_litecoin_locale_qrc to CLEAN_QT to fix make distcheck (fanquake)
...
- #11711 `6378e5c` litecoin_qt.m4: Minor fixes and clean-ups (fanquake)
...
- #11297 `16e4184` Make sure ~/.litecoin doesn't exist before build (MeshCollider)
...
- #11143 `3aa60b7` Fix include path for litecoin-config.h (danra)
...
- #10871 `c9a4aa8` Handle getinfo in litecoin-cli w/ -getinfo (revival of #8843) (achow101)
- #11419 `093074b` Utils: Fix launchctl not being able to stop litecoind (OmeGak)
...
- #10529 `331352f` Improve litecoind systemd service file (Flowdalic)
