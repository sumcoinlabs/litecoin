Litecoin Core version 0.14.1 is now available from:

  <https://litecoin.org/bin/litecoin-core-0.14.1/>
...
here:
[reducing-litecoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` litecoin-tx input verification (awemany, jnewbery)
