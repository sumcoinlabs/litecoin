...
All other packaging related files can be found in the [litecoin-core/packaging](https://github.com/litecoin-core/packaging) repository.

### [Gitian-descriptors](/contrib/gitian-descriptors) ###
Files used during the gitian build process. For more information about gitian, see the [the Litecoin Core documentation repository](https://github.com/litecoin-core/docs).
