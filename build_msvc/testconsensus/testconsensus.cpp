...
// litecoin includes.
#include <..\src\script\litecoinconsensus.h>
...
int main()
{
    std::cout << "litecoinconsensus version: " << litecoinconsensus_version() << std::endl;
    ...
    auto op0Result = litecoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, litecoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
