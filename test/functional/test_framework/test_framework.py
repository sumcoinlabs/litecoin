...
>>>>>>> 28c3cad38365b51883be89e7a306ac7eae1d9ba5
    ...
    def __new__(cls, clsname, bases, dct):
        if not clsname == 'LitecoinTestFramework':
            if not ('run_test' in dct and 'set_test_params' in dct):
                raise TypeError("LitecoinTestFramework subclasses must override "
                                "'run_test' and 'set_test_params'")
            if '__init__' in dct or 'main' in dct:
                raise TypeError("LitecoinTestFramework subclasses may not override "
                                "'__init__' or 'main'")
...
>>>>>>> 28c3cad38365b51883be89e7a306ac7eae1d9ba5
    ...
    def add_nodes(self, num_nodes, extra_args=None, *, rpchost=None, binary=None):
        ...
        if binary is None:
            binary = [self.options.litecoind] * num_nodes
