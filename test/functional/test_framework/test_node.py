...
class TestNode():
    ...
    def __init__(self, i, datadir, *, rpchost, timewait, litecoind, litecoin_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False):
        """
        Kwargs:
...
>>>>>>> 28c3cad38365b51883be89e7a306ac7eae1d9ba5
    ...
    def wait_for_rpc_connection(self):
        ...
        for _ in range(poll_per_s * self.rpc_timeout):
            ...
            except ValueError as e:  # cookie file not found and no rpcuser or rpcassword. litecoind still starting
...
class TestNodeCLI():
    ...
    def __init__(self, binary, datadir):
        ...
        self.datadir = datadir
        self.input = None
        self.log = logging.getLogger('TestFramework.litecoincli')
