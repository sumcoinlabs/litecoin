...
class ToolWalletTest(LitecoinTestFramework):
    ...
    def litecoin_wallet_process(self, *args):
    ...
    def assert_raises_tool_error(self, error, *args):
        p = self.litecoin_wallet_process(*args)
    ...
    def run_test(self):
        ...
        # `litecoin-wallet help` is an error. Use `litecoin-wallet -help`
