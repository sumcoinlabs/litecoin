#!/usr/bin/env python3
# Copyright (c) 2014-2018 The Litecoin Core developers
...
`test/functional/test_framework/test_framework.py:LitecoinTestFramework.main`.
...
=======
    ...
    if config["environment"]["EXEEXT"] == ".exe" and not args.force:
        # https://github.com/litecoin/litecoin/commit/d52802551752140cf41f0d9a225a43e84404d3e9
        # https://github.com/litecoin/litecoin/pull/5677#issuecomment-136646964
...
def run_tests(*, test_list, src_dir, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, runs_ci):
    ...
    # Warn if litecoind is already running (unix only)
    try:
