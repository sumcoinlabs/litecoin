...
typedef enum litecoinconsensus_error_t
{
    ...
    litecoinconsensus_ERR_INVALID_FLAGS,
...
enum
{
    ...
    litecoinconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY           = (1U << 4), // enforce NULLDUMMY (BIP147)
    ...
    litecoinconsensus_SCRIPT_FLAGS_VERIFY_ALL                 = litecoinconsensus_SCRIPT_FLAGS_VERIFY_P2SH | litecoinconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |
                                                               litecoinconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY | litecoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY |
                                                               litecoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY | litecoinconsensus_SCRIPT_FLAGS_VERIFY_WITNESS
};
