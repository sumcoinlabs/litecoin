...
#include <qt/litecoinaddressvalidator.h>
...
bool GetStartOnSystemStartup()
{
    ...
    if (litecoinAppUrl == nullptr) {
        return false;
    }

    LSSharedFileListRef loginItems = LSSharedFileListCreate(nullptr, kLSSharedFileListSessionLoginItems, nullptr);
    CFArrayRef listSnapshot = LSSharedFileListCopySnapshot(loginItems, nullptr);
    bool res = (findStartupItemInList(listSnapshot, loginItems, litecoinAppUrl) != nullptr);
    CFRelease(litecoinAppUrl);
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    LSSharedFileListRef loginItems = LSSharedFileListCreate(nullptr, kLSSharedFileListSessionLoginItems, nullptr);
    CFArrayRef listSnapshot = LSSharedFileListCopySnapshot(loginItems, nullptr);
    LSSharedFileListItemRef foundItem = findStartupItemInList(listSnapshot, loginItems, litecoinAppUrl);

    if(fAutoStart && !foundItem) {
        // add litecoin app to startup item list
        LSSharedFileListInsertItemURL(loginItems, kLSSharedFileListItemBeforeFirst, nullptr, nullptr, litecoinAppUrl, nullptr, nullptr);
    }
