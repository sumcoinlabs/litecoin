...
//! Entry point for LitecoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &LitecoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for LitecoinGUI tests.
void AppTests::guiTests(LitecoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &LitecoinGUI::consoleShown, this, &AppTests::consoleTests);
