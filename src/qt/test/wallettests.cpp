...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<LitecoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_litecoin-qt -platform xcb      # Linux
//     src/qt/test/test_litecoin-qt -platform windows  # Windows
//     src/qt/test/test_litecoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = LitecoinUnits::formatWithUnit(unit, balance, false, LitecoinUnits::separatorAlways);
    ...
    // Amount input
    LitecoinAmountField* amountInput = receiveCoinsDialog.findChild<LitecoinAmountField*>("reqAmount");
