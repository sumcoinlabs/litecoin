...
#include <qt/litecoinamountfield.h>
...
private:
    int currentUnit{LitecoinUnits::LTC};
    CAmount singleStep{CAmount(100000)}; // satoshis
    mutable QSize cachedMinimumSizeHint;
    bool m_allow_empty{true};
    CAmount m_min_amount{CAmount(0)};
    CAmount m_max_amount{LitecoinUnits::maxMoney()};
...
#include <qt/litecoinamountfield.moc>
    ...
    amount(nullptr)
{
    ...
    connect(amount, &AmountSpinBox::valueChanged, this, &LitecoinAmountField::valueChanged);
    connect(unit, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &LitecoinAmountField::unitChanged);
...
void LitecoinAmountField::SetAllowEmpty(bool allow)
{
    amount->SetAllowEmpty(allow);
}

void LitecoinAmountField::SetMinValue(const CAmount& value)
{
    amount->SetMinValue(value);
}

void LitecoinAmountField::SetMaxValue(const CAmount& value)
{
