    ...
    mapper(nullptr)
{
    ...
    ui->litecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->litecoinAtStartup);
    ...
    ui->openLitecoinConfButton->setToolTip(ui->openLitecoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
...
void OptionsDialog::on_openLitecoinConfButton_clicked()
{
