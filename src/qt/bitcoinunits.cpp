...
QString LitecoinUnits::longName(int unit)
{
    switch(unit)
    {
...
QString LitecoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case uLTC: return QString::fromUtf8("bits");
...
QString LitecoinUnits::getAmountColumnTitle(int unit)
{
    ...
    {
        amountTitle += " ("+LitecoinUnits::shortName(unit) + ")";
    }
    return amountTitle;
}
